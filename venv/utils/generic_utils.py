...
def load_dataset_at(index, fold_index=None, normalize_timeseries=False, verbose=True) -> (np.array, np.array):
    ...
    if fold_index is None:
        x_train_path = TRAIN_FILES[index] + "X_train.txt"
        y_train_path = TRAIN_FILES[index] + "y_train.txt"
        x_test_path = TEST_FILES[index] + "X_test.txt"
        y_test_path = TEST_FILES[index] + "y_test.txt"
    else:
