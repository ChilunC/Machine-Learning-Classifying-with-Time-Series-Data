...
@tf_export('accumulator_apply_gradient')
...
@tf_export('accumulator_num_accumulated')
...
@tf_export('accumulator_set_global_step')
...
@tf_export('accumulator_take_gradient')
...
@tf_export('conditional_accumulator')
...
@tf_export('ordered_map_incomplete_size')
...
@tf_export('ordered_map_unstage_no_key')
...
@tf_export('parallel_dynamic_stitch')
...
@tf_export('sparse_accumulator_apply_gradient')
...
@tf_export('sparse_accumulator_take_gradient')
...
@tf_export('sparse_conditional_accumulator')
