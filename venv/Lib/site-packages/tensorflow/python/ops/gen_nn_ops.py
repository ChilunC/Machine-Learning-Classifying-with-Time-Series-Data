...
@tf_export('conv2d_backprop_filter')
...
@tf_export('conv2d_backprop_input')
...
@tf_export('conv3d_backprop_filter')
...
@tf_export('conv3d_backprop_filter_v2')
...
@tf_export('conv3d_backprop_input')
...
@tf_export('conv3d_backprop_input_v2')
...
def data_format_dim_map(x, src_format="NHWC", dst_format="NCHW", name=None):
  ...
  if _ctx.in_graph_mode():
    ...
    _inputs_flat = [x]
    _attrs = ("T", _attr_T, "src_format", src_format, "dst_format",
              dst_format)
...
@tf_export('data_format_vec_permute')
def data_format_vec_permute(x, src_format="NHWC", dst_format="NCHW", name=None):
  ...
  if _ctx.in_graph_mode():
    ...
    _attrs = ("T", _attr_T, "src_format", src_format, "dst_format",
              dst_format)
    _result = _execute.execute(b"DataFormatVecPermute", 1,
                               inputs=_inputs_flat, attrs=_attrs, ctx=_ctx,
                               name=name)
  _execute.record_gradient(
...
@tf_export('dilation2d_backprop_filter')
...
@tf_export('dilation2d_backprop_input')
...
@tf_export('fused_batch_norm_grad')
...
@tf_export('fused_batch_norm_grad_v2')
...
@tf_export('fused_resize_and_pad_conv2d')
...
@tf_export('max_pool_grad_grad_v2')
...
@tf_export('quantized_batch_norm_with_global_normalization')
