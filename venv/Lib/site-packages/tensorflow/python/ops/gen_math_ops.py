...
def _mean(input, axis, keep_dims=False, name=None):
...
def _prod(input, axis, keep_dims=False, name=None):
...
@tf_export('quantize_down_and_shrink_range')
...
@tf_export('requantization_range')
...
def _select(condition, x, y, name=None):
...
@tf_export('sparse_segment_mean_grad')
...
@tf_export('sparse_segment_mean_with_num_segments')
...
@tf_export('sparse_segment_sqrt_n_grad')
...
@tf_export('sparse_segment_sqrt_n_with_num_segments')
...
@tf_export('sparse_segment_sum_with_num_segments')
